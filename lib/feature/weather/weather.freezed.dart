...
abstract class $WeatherCopyWith<$Res> {
  ...
  @useResult
  $Res call({Temperature temperature, WeatherData weatherData});
...
class _$_Weather implements _Weather {
  const _$_Weather({required this.temperature, required this.weatherData});
  ...
  @override
  String toString() {
    return 'Weather(temperature: $temperature, weatherData: $weatherData)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, temperature, weatherData);
...
abstract class _Weather implements Weather {
  const factory _Weather(
      ...
      required final WeatherData weatherData}) = _$_Weather;
